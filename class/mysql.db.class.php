...
#------------------------------------------------------------------------------
#[谢您使用谷铂软件企业站程序：qgweb]
#[本程序由谷铂软件开发完成，当前版本：5.0]
#[本程序基于LGPL授权发布]
#[如果您使用正式版，请将授权文件用FTP上传至copyright目录中]
#[官方网站：www.gootopsoft.cn   www.gootop.net]
#[客服邮箱：max.zhang@gootop.net]
#[文件：mysql.class.php]
#------------------------------------------------------------------------------
...
class MySql
{
	...
	#[构造函数]
	function MySql($dbhost,$dbdata,$dbuser="",$dbpass="",$dbOpenType=false)
	{
		$this->host = $dbhost;
		$this->user = $dbuser;
		$this->pass = $dbpass;
	...
	{
		$this->MySql($dbhost,$dbdata,$dbuser,$dbpass,$dbOpenType);
		unset($dbhost,$dbdata,$dbuser,$dbpass,$dbOpenType);
	}
