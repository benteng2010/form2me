...
<tr>
	...
	<td class="right">
		...
		<span class="clue_on">[填写完整的邮箱，如：max.zhang@gootop.net]</span>
	</td>
</tr>
</table>
</div>
...
<tr>
	...
	<td class="right">
		...
		<span class="clue_on">[GOOTOPCMS官方推荐使用裁剪式的缩略图，可以保证图片不会变型]</span>
	</td>
</tr>
</table>
</div>
...
<tr>
	...
	<td class="right">
		...
		<span class="clue_on">[设置缩略图的宽和高，建议设置其比例为 4:3 GOOTOPCMS官方推荐您使用 160×120 ]</span>
	</td>
</tr>
</table>
</div>
...
function SystemSet()
{
	...
	if(idtrue)
	{
		...
		if(!gdpic)
		{
			alert("水印图片不能为空！GOOTOPCMS不再支持文字水印！");
			return false;
		}
	}
	//更新
