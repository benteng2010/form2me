...
<tr>
	...
	<td class="right">
		...
		<tr>
			<td><input type="radio" name="status" id="mailstatus_1" value="1"<?php if($rs[status]){?> checked<?php } ?>></td>
			<td>启用</td>
			<td><input type="radio" name="status" id="mailstatus_0" value="0"<?php if(!$rs[status]){?> checked<?php } ?>></td>
			<td>禁用</td>
...
<tr>
	<td class="left">签名：</td>
	<td class="right"><input type="text" name="sign" id="sign" value="<?php echo $rs[sign];?>" class="long_input"></td>
</tr>
</table>
</div>
...
<tr>
	...
	<td class="right">
		...
		<option value="ordermsg_to_user"<?php if($usetype == "ordermsg_to_user"){?> selected<?php } ?>>下订单给客户发送通知</option>
		<option value="ordermsg_to_admin"<?php if($usetype == "ordermsg_to_admin"){?> selected<?php } ?>>下订单给管理员发送通知</option>
		</select>
...
<tr>
	...
	<td class="right">
		<input type="text" name="subject" id="subject" class="long_input" value="<?php echo $msg[subject];?>">
...
<?php QG_C_TEMPLATE::p("fckeditor.msg","","0");?>
<div class="table">
<table width="100%">
<tr>
	<td class="left"></td>
...
<tr>
	...
	<td class="right">
		<input type="text" name="touser" id="touser" class="long_input" value="<?php echo $email;?>">
