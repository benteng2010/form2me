...
<title>GOOTOP-CMS [version <?php echo VERSION;?>] 后台管理 - Powered By gootop.net</title>
...
<tr>
	<td>
		...
		<tr>
			<td height="25px" style="background:#4455aa;color:white;" align="center">GOOTOP-CMS后台管理登录</td>
		</tr>
		</table>
		<table style="width:350px;" border="0" cellspacing="0" cellpadding="0" align="center">
		<tr>
		...
		<tr>
			...
			<td valign="middle" class="forumRow" align="left">
				...
				<tr>
					...
					<td id="updatecode"><img src="admin.php?act=chkcode&codeType=admin" border="0" align="absmiddle" style="cursor:pointer;" onclick="qgupdatecode()"></td>
				</tr>
				</table>
			</td>
		</tr>
...
function qgupdatecode()
{
	...
	$('updatecode').innerHTML = '<img src="admin.php?act=chkcode&codeType=admin&rand=' + rand + '" border="0" align="absmiddle" style="cursor:pointer;" onclick="qgupdatecode()">';
}
</script>
