...
<style type="text/css">
.matrix_picker li.color_select {border:2px solid #00FF00;}
#fullbg{
    ...
    <div id="form_main">
    	<div class="form_edit">
        	<div class="form_edit_theme_manager">
                ...
                <div class="form_bxk">
                    <img src="templates/zh/default/images/theme_mid_image.png" />
                </div>
                ...
                <div class="menu_level3" style="display: none;">
                    ...
                    <div class="color_preview_wrap pattern_ext_menu" style="display: block;">
                        ...
                        <input class="color_input" type="text" name="color_input" size="7" maxlength="7" />
                    </div>
                    <div class="clear"></div>
                </div>
                </div>
            <div class="form_emf_container_outer" >
                <div class="form_emf_container" style="border: 1px solid #999;">
                	<div class="form_emf_container_a">
                    	<a style="height: 40px;">EmailMeForm</a>
                    </div>
                    <div class="form_emf_container_b">
                        ...
                        <ul>
                            ...
                            <li class="form_emf_li_field" style="text-align:left">
                                <label class="form_emf_label_desc">
                                    Email
                                    <span>*</span>
                                </label>
                                <div class="emf-div-field">
...
<div id="dialog">
	...
	<div id="TB_ajaxContent" style="width: 400px; height: 135px; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
		<div class="TB_content">
			...
			<div class="TB_content_button" style="margin: 35px auto 0pt; text-align: center;">
				<a class="upgrade" style="display:inline;" onclick="jQuery('#themeUP').submit();" href="javascript:void(0);">
                    <img src="templates/zh/default/images/dialog-box-button-save.png" />
				</a>
                <img src="templates/zh/default/images/dialog-box-button-close.png" class="second" onclick="closeBg();" />
			</div>
			</form>
		</div>
	</div>	
...
jQuery(document).ready(function(){
	jQuery('#property > li').bind('click',function(){
		...
		jQuery('#typography > li').bind('click',function(){				
			var pt = jQuery('#property > .selected').html();
			var ty = jQuery(this).html();
			if(pt == '背景'){
				if(ty == '壁纸'){
...
function delTheme(id){
	window.location = GM.RootScript+'/themeManage.phpact=del&id='+id;
}
</script>
